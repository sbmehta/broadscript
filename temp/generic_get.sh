...
TOPDIR="project-FPgF38Q0bg5f24jb13v65Pf1"

ACCEPTFILTER_RE="kraken-summary_report"      # ** Accept only files whose full paths match this regex
...
REMOVETEXT_RE="s/ignoreme//g"   # ** remove text matching this sed regex from output filename
